...
pub fn get_key_from_keyboard() -> Keys {
    ...
    match buffer {
        ...
        [0x09, 0x00, 0x00] => key = Keys::Ctrl('g'),
        ...
        [0x1b, 0x41, 0x00] => key = Keys::Alt('A'),
        [0x1b, 0x42, 0x00] => key = Keys::Alt('B'),
        [0x1b, 0x43, 0x00] => key = Keys::Alt('C'),
        [0x1b, 0x44, 0x00] => key = Keys::Alt('D'),
        [0x1b, 0x45, 0x00] => key = Keys::Alt('E'),
        [0x1b, 0x46, 0x00] => key = Keys::Alt('F'),
        [0x1b, 0x47, 0x00] => key = Keys::Alt('G'),
        [0x1b, 0x48, 0x00] => key = Keys::Alt('H'),
        [0x1b, 0x49, 0x00] => key = Keys::Alt('I'),
        [0x1b, 0x4a, 0x00] => key = Keys::Alt('J'),
        [0x1b, 0x4b, 0x00] => key = Keys::Alt('K'),
        [0x1b, 0x4c, 0x00] => key = Keys::Alt('L'),
        [0x1b, 0x4d, 0x00] => key = Keys::Alt('M'),
        [0x1b, 0x4e, 0x00] => key = Keys::Alt('N'),
        [0x1b, 0xc3, 0x91] => key = Keys::Alt('Ñ'),
        [0x1b, 0x4f, 0x00] => key = Keys::Alt('O'),
        [0x1b, 0x50, 0x00] => key = Keys::Alt('P'),
        [0x1b, 0x51, 0x00] => key = Keys::Alt('Q'),
        [0x1b, 0x52, 0x00] => key = Keys::Alt('R'),
        [0x1b, 0x53, 0x00] => key = Keys::Alt('S'),
        [0x1b, 0x54, 0x00] => key = Keys::Alt('T'),
        [0x1b, 0x55, 0x00] => key = Keys::Alt('U'),
        [0x1b, 0x56, 0x00] => key = Keys::Alt('V'),
        [0x1b, 0x57, 0x00] => key = Keys::Alt('W'),
        [0x1b, 0x58, 0x00] => key = Keys::Alt('X'),
        [0x1b, 0x59, 0x00] => key = Keys::Alt('Y'),
        [0x1b, 0x5a, 0x00] => key = Keys::Alt('Z'),
        _ => {}
    }
    std::io::stdout().flush().unwrap();
